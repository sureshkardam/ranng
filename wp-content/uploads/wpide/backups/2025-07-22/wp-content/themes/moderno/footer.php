...
<footer
	class="l-section sakir c-footer c-footer--mobile-buttons-<?php echo ideapark_mod( 'bottom_buttons_mobile_locations' ); ?> <?php ideapark_class( ! $ideapark_footer && ideapark_mod( 'footer_copyright' ), 'c-footer--simple' ); ?><?php if ( ideapark_mod( 'sticky_add_to_cart' ) ) { ?> c-footer--sticky-add-to-cart<?php } ?>">
