...
function add_our_process_footer_scripts() {
    ...
    wp_enqueue_script(
        ...
        array('gsap-js'), // Depends on GSAP core
        false,
        true
    );
    ...
    wp_enqueue_script(
        ...
        array('gsap-js'), // Also depends on GSAP core
        false,
        true
    );
}
...
function add_custom_gsap_scripts() {
    // GSAP Core
    wp_enqueue_script(
        'gsap-js',
        get_template_directory_uri() . '/assets/js/gsap.min.js',
...
add_action('wp_enqueue_scripts', 'add_custom_gsap_scripts');
